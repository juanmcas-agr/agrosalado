// Lógica real del scraper de Novillo — separada de scraper-novillo.js (el
// wrapper programado) para poder compartirla con
// actualizar-precios-relativos.js. Ver la nota en scraper-novillo.js.
//
// Mercado Agroganadero (mercadoagroganadero.com.ar), categoría "NOVILLITOS
// EyB P. 391/430", columna Promedio — confirmado por Juan con una captura
// de la página real. La página es un formulario clásico (sin login) que
// responde a un POST con rango de fechas; se probó server-side (sin
// browser) y funciona con un POST plano.
...
async function ejecutarNovillo() {
  ...
  try {
    ...
    if (!promedio) {
      return { ok: false, mensaje: `Sin datos para "${CATEGORIA}" en el rango consultado.` };
    }
...
module.exports = { ejecutarNovillo };
