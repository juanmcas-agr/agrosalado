...
-- "Absorber posición": el owner marca que una parte (o todo) del saldo
-- libre de una compra queda absorbida por la empresa, sin asignarla a
-- una venta real — a diferencia de asignaciones_compra_venta, esto NO
-- toca el lado de ventas, así que el total "comprado" del resumen por
-- cereal sigue contando esa compra entera (sigue a favor de la
-- empresa), solo deja de figurar como saldo libre/pendiente.
